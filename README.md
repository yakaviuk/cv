...
- **Application and Infrastructure Migration**: Expertise in seamless migration of applications and websites:
  ...
  - From Windows to Linux platforms.
...
- **Tech Stack**:
  ...
  - **Networking & Security**: WireGuard, Netbird (VPN).

### Apr-2023 - Oct-2023 
**Lead DevOps Engineer, EPAM Systems**
- **Tool Analysis and Selection**: Researched, analyzed, and selected the most suitable tools for CI/CD and orchestration based on project requirements and scalability needs.
- **CI/CD Pipeline Setup**: Implemented and optimized CI/CD pipelines using Harness IO to streamline and automate the deployment process.
- **Source Code Migration**: Prepared and executed the migration strategy for source code repositories, ensuring a smooth and efficient transition.
- **Cloud Migration Planning**: Led the planning and preparation for migrating applications from bare-metal servers to the cloud, focusing on minimizing downtime and optimizing performance.
- **Google Kubernetes Engine (GKE) Setup**: Set up and configured GKE clusters to facilitate container orchestration and application scalability within the Google Cloud Platform (GCP).
- **Infrastructure as Code**: Utilized Terraform to automate and manage cloud infrastructure, ensuring consistency and repeatability across environments.
- **Tools and Technologies**: GCP, Google Spanner, GKE, Harness IO, GitHub, ArgoCD, Kubernetes, Terraform, Bash, Git.
...
- **Web and Application Server Configuration**: Configured and maintained web and application servers (Nginx, Apache, PHP-FPM, IIS, MSSQL, FTP, phpMyAdmin) for hosting and application delivery.
- **SSL Management**: Installed SSL certificates, including generating free SSL certificates, to secure web services.
- **Backup Configuration**: Designed and implemented backup solutions to ensure data protection and recovery.
- **Mail Service Setup**: Installed and maintained mail services (Postfix, Exim, Dovecot, Sendmail) to provide reliable email delivery.
- **Tools and Technologies**: MySQL (MariaDB, Percona), MS SQL, Kayako, Jira, Zabbix, Apache, Nginx, PHP-FPM, Linux (CentOS, RedHat, Ubuntu, Debian), Windows servers, IIS, ISPmanager, BitrixEnv, Mail Servers (Exim, Dovecot), FTP.
